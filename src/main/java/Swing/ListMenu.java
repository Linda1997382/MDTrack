...
public class ListMenu<E extends Object> extends JList<Object> {
    ...
    public ListCellRenderer<? super Object> getCellRenderer() {
        return new DefaultListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList<?> list, Object o, int index, boolean selected, boolean focus) {
                ...
                MenuIntem item = new MenuIntem(data);
    ...
    public ListCellRenderer<? super Object> getCellRenderer() {
        return new DefaultListCellRenderer() {
            @Override public Component getListCellRendererComponent(
                    JList<?> list, Object o, int index, boolean selected, boolean focus) {

                Model_Menu data = (o instanceof Model_Menu)
                        ? (Model_Menu) o
                        : new Model_Menu("", o + "", Model_Menu.MenuType.EMPTY);
    ...
    public Model_Menu getItemAtIndex(int index) {
        Object o = model.get(index);
        return (o instanceof Model_Menu) ? (Model_Menu) o : null;
    }
